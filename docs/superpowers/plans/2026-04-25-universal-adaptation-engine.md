...
**Goal:** 实现 convention_scanner.py + 修改编排流，使 sisyphus-autoflow 能自动检测目标项目的代码规范并生成匹配代码
...
修改:
  ...
  skills/autoflow/SKILL.md            — 预检加载 fingerprint
  skills/using-autoflow/SKILL.md      — 扫描增加 fingerprint 生成步骤
```
...
检查输出 `.autoflow/convention-scout.json` 的关键字段：
- api.type = enum
...
- [ ] **Step 2: 修改 skills/autoflow/SKILL.md 预检阶段**
...
- [ ] **Step 3: 修改 skills/using-autoflow/SKILL.md**
...
```bash
git add prompts/code-style-python.md skills/autoflow/SKILL.md skills/using-autoflow/SKILL.md
